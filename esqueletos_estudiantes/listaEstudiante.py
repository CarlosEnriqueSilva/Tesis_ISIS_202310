...
class NodoLista:
    ...
    def __init__(self, infoNodo):
        ...
        Uso: Para crear/obtener un nodo nuevo, hay que usar funcion NodoLista(elemento)
    ...
    def setNext(self, nodoNext):
        '''
        Modifica la referencia al sigueinte nodo de la lista
        Args:
            referencia al nuevo nodo siguiente en la lista
...
class listaEnlazada():
    ...
    def addNode_byValue(self, infoNodo):
        ...
        Si el elemento ya se encuentra en la lista, se añade una nueva ocurrencia
        ...
        nodo = NodoLista(infoNodo)    #nuevo nodo
    ...
    def getNodeValues(self):
        '''
        Retorna todos los elementos de la lista en el orden del primero al ultimo
        ...
        lst = list()
        actual = self.estructura['first']
        while actual != None:
            lst.append(actual.getInfo())
    ...
    def findAdjacentNode(self, infoNodo):
        '''
        Devuelve el elemento del nodo adyacente a un nodo dado. 
